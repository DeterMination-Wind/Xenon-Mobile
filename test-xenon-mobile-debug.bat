...
pushd %BUILD_DRIVE%\
call gradlew.bat -g .gradle-user-home-local --no-daemon --max-workers=1 "-Dorg.gradle.jvmargs=-Xmx4g -XX:MaxMetaspaceSize=512m -Dfile.encoding=GBK" :ZalithLauncher:testDebugUnitTest %*
